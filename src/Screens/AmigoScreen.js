...
import { StyleSheet, ImageBackground, FlatList, View, TouchableOpacity, Share, SafeAreaView } from 'react-native';
import { Text, Avatar, Button, Icon } from '@ui-kitten/components';
import LottieView from 'lottie-react-native';

export default function AmigoScreen({ navigation }) {
    ...
    useEffect(() => {
        ...
        fetch('https://mincrix.com/getfriends/' + global.id, {
            method: 'GET'
        })
